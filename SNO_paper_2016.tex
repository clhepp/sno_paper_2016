...
\begin{figure}[htb]
  \centering
  \subfloat[Long Wave]
           {\includegraphics[width=0.45\linewidth]{./figs/IC_jplSNO_Bias_stdErr_LW.pdf} }
  \,
  \subfloat[Medium Wave]
           {\includegraphics[width=0.45\linewidth]{./figs/IC_jplSNO_Bias_stdErr_MW.pdf} }
...
\begin{figure}[htb]
    \centering
    \subfloat[Long Wave]
             {\includegraphics[width=6cm]{./figs/IC_jplSNO_dayNight_Bias_stdErr_LW.pdf} }
    \,
    \subfloat[Medium Wave]
             {\includegraphics[width=6cm]{./figs/IC_jplSNO_DayNight_Bias_stdErr_MW.pdf} }
...
\begin{figure}[htb]
  \centering
  \subfloat[Long Wave]
           {\includegraphics[width=0.475\linewidth]{./figs/IC_jplSNO_northSouth_Bias_stdErr_LW.pdf}}
  \,
  \subfloat[Medium Wave]
           {\includegraphics[width=0.475\linewidth]{./figs/IC_jplSNO_NorthSouth_Bias_stdErr_MW.pdf}}
...
\begin{figure}[htb]
  \centering
  \subfloat[LW]{
     \includegraphics[width=0.475\linewidth]{./figs/AC_jplSNO_Bias_stdErr_wModEdges_LW.pdf}}
  \,
  \subfloat[MW]{
     \includegraphics[width=0.475\linewidth]{./figs/AC_jplSNO_Bias_stdErr_wModEdges_MW.pdf}}
